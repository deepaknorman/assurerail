...
**Current commercial policy (16 September):** ₹500 per unique seller-loan-borrower pair plus ₹250 per separate linked loan-party pair for the execution-committed route (₹8L seller minimum), or ₹650 plus ₹325 respectively for standalone (₹10.4L seller minimum). Above ₹100cr of aggregate accepted programme consideration, the excess carries a 10bps committed or 13bps standalone supplement allocated to sellers by proposed consideration. The common Initial Assessment payment is 30% of the complete standalone fixed quote: ₹3.12L at the minimum. Initial Assessment is automated and unsigned, with no consultant review included. Portfolio Preparation requires qualified expert review and sign-off. Execution fees are additional and seller-specific; additional services require separate selection and acceptance. Top-up applies only to voluntary switch/withdrawal of an accepted execution mandate, not failed close or buyer rejection alone. The generated commercial-policy register is the calculation source for new quotes.
...
| Portfolio Preparation | Selected route total less initial payment: committed ₹500 per primary pair + ₹250 per linked party (min ₹8L) or standalone ₹650 + ₹325 respectively (min ₹10.4L), plus any allocated large-programme supplement | Pay the full incremental amount upfront before preparation begins. Qualified expert review and sign-off are included. |
| Buyer Review & Execution | Seller-specific Platform Execution & Success Fee: marginal 40bps on the first ₹25cr and 30bps above ₹25cr, with a ₹5L seller minimum. Additional services separately selected and quoted | Calculated cumulatively on that seller's share of actual purchase consideration successfully settled. Collected from escrow at successful settlement under the accepted distribution schedule. |

The founder expressly selected each **seller's share of actual purchase consideration settled**, rather than loan principal proposed or transferred, as the execution fee base. The success fee is **additional to assessment/preparation fees**: committed-route stage payments do not reduce it; only a standalone-premium conversion credit is eligible. Freeze the rate, seller basis, cumulative prior settlements, minimum and completion trigger in the execution quote.
...
3. **Create Initial Assessment engagement.** Capture asset, book, cutoff, unique seller-loan-borrower pair count, separate linked-party count, seller proposed consideration, aggregate programme consideration and ownership/data authority; check supported scope before charging. Show fixed fee, applicable taxes, included outputs, review cycles and correction window. Recalculate every declared-versus-admitted variance; there is no tolerance band. Accept the order and processing terms with versioned authority evidence.
...
- Freeze both alternative quotes and the complete count/corpus scope. New offers expire at 5pm IST on the first Monday after the twentieth calendar day, subject to an earlier underlying contract or rate-card expiry. A committed order needs an explicit mandate, scope, term and responsibilities. Existing buyers do not automatically trigger a buyer-arrangement add-on. Core fee and additional scopes need explicit acceptance.
...
Standalone conversion: the full standalone premium actually paid for the same agreed scope is credited against eligible AssureRail execution fees at successful closing, capped at cumulative fees earned and applied once across partial closes. No cash refund or tax/external-cost offset. The premium is the accepted standalone fixed quote less the accepted committed fixed quote, including the different count rates, minima and any allocated large-programme supplement. The committed route has no additional fixed-stage credit. This replaces the earlier 50% preparation-credit suggestion. Agree the execution scope, credit validity, eligible scope and treatment of refunds/reversals before conversion. No standalone conversion uptake or withdrawal recovery is assumed in the aggregate forecast.

## Current modular execution proposal

The founder agreed **Platform Execution & Success Fee + Additional Services**. Customer-facing metal tiers are superseded; additional-service rates still need accepted quotes. The seller-specific marginal 40/30bps schedule is the core success fee, calculated cumulatively for each seller. Itemise optional arrangement, managed escrow coordination, custom buyer LMS/ERP integration, recurring technical feeds and monitoring/support. Buyer requirements describe outcomes; they do not auto-select paid services or remove the seller's acceptable provider choices. Nothing paid is preselected. Qualified expert review is included only in Portfolio Preparation; Initial Assessment remains automated and unsigned. Standard buyer-format export is included within core scope; custom connectors are separately quoted after reuse review.
