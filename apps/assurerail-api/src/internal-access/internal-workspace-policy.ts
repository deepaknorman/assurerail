...
export const INTERNAL_WORKSPACES = [
  ...
  },
  {
    ...
    summary: "Contracts, rate cards, usage, statements, credits, cohorts, service and operating reviews.",
    ...
    escalation: ["MANAGER as maker", "RISK_COMPLIANCE_OFFICER as independent reviewer", "SUPPORT_ANALYST for service only", "finance, tax, customer or route authority as applicable"],
    boundary: "Commercial and support authority cannot grant route permission, rewrite evidence, establish ownership, close a break or complete a transaction.",
  },
  {
    id: "RISK",
