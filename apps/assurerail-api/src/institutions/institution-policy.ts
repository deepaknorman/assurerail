export const INSTITUTION_ACTIONS = [
  "VIEW_BUYER_PROFILE",
  "EDIT_BUYER_PROFILE",
  "APPROVE_BUYER_CREDIT",
  "APPROVE_BUYER_LEGAL",
  "APPROVE_BUYER_OPERATIONS",
  "VIEW_INSTITUTION",
  "ADMINISTER_MEMBERS",
  "PROPOSE_AUTHORITY",
  "APPROVE_AUTHORITY",
...
export const STEP_UP_PURPOSES = [
  "ENGAGEMENT_ACCEPT",
  "ENGAGEMENT_PREPARATION_ACCEPT",
  "ENGAGEMENT_PROCESSING_REQUEST",
  "ENGAGEMENT_REMEDIATION_PLAN",
  "ENGAGEMENT_REPORT_REVIEW",
  "BUYER_PROFILE_SAVE",
  "BUYER_PROFILE_SUBMIT",
  "BUYER_PROFILE_REVIEW",
  "ASSESSMENT_PROVIDER_LAUNCH",
  "INTERNAL_BUYER_MSA_PROPOSE",
  "INTERNAL_BUYER_MSA_VERIFY",
  ...
  "INTERNAL_PAYMENT_RECEIPT_PROPOSE",
  "INTERNAL_PAYMENT_RECEIPT_REVIEW",
