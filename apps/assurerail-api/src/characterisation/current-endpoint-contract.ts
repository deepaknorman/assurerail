...
export const CURRENT_ENDPOINT_CONTRACT: readonly CurrentEndpointContract[] = [
  ...
  e("POST", "/venue/webhooks/:id/verify", "PLATFORM_ADMIN", "INTEGRATION_SECRET", "PLATFORM"),
  ...
  e("POST", "/venue/webhooks/deliveries/:id/replay", "PLATFORM_ADMIN", "OPERATIONS_CONFIDENTIAL", "PLATFORM"),
