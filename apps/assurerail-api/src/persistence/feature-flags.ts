...
export const PTC_PRODUCT_FLAG = "ARAIL_PTC_PRODUCT_V1" as const;
export const PTC_PRODUCT_VALUES = ["off", "shadow"] as const;
export type PtcProductMode = (typeof PTC_PRODUCT_VALUES)[number];

export const LIFECYCLE_PRODUCT_FLAG = "ARAIL_LIFECYCLE_PRODUCT_V1" as const;
...
export type SecondaryProductMode = (typeof SECONDARY_PRODUCT_VALUES)[number];
...
export function inspectPersistenceFlags(env: Environment): {
  ...
  return {
    ...
    ptcProduct: ptcProduct.value,
    lifecycleProduct: lifecycleProduct.value,
    ...
    errors: [ingress.error, relay.error, admission.error, entitlement.error, transactionCase.error,
      ...
      conventionalSecondary.error, venueConduct.error, developerPortal.error, customerOperations.error, hostedAlpha.error, institutionalProduct.error, daProduct.error, ptcProduct.error, lifecycleProduct.error, primaryVenueProduct.error, secondaryProduct.error,
      internalRbac.error]
