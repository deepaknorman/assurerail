...
import { ExecutionFeeInvoiceInternalController, ExecutionFeeInvoiceParticipantController } from "./execution-fee-invoice.controllers";

@Module({ imports: [StoreModule, SecurityModule, InstitutionsModule, InternalAccessModule, EvidenceModule], controllers: [ExecutionFeeInvoiceParticipantController, ExecutionFeeInvoiceInternalController, AssessmentProcessingController, AssessmentProcessingInternalController, EngagementCheckoutController, EngagementPaymentWebhookController, AssessmentEngagementController, AssessmentEngagementInternalController, EngagementBillingParticipantController, EngagementBillingInternalController, CustomerOperationsParticipantController, CustomerOperationsInternalController], providers: [ExecutionFeeInvoiceService, AssessmentProcessingService, AssessmentProcessingWorker, EngagementCheckoutService, EngagementPaymentWorker, AssessmentEngagementService, EngagementBillingService, CustomerOperationsService], exports: [AssessmentEngagementService, ExecutionFeeInvoiceService] })
