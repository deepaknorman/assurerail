...
import { availability, customerWorkspaceEnabled, daProductEnabled, evidenceDisplayState, lifecycleProductEnabled, ptcProductEnabled, qualificationText, secondaryProductEnabled, stateTone, type Availability } from "@/lib/customer-workspace";
