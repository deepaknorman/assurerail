...
import { availability, customerWorkspaceEnabled, daProductEnabled, evidenceDisplayState, ptcProductEnabled, qualificationText, stateTone, type Availability } from "@/lib/customer-workspace";
