...
import { activeMandateActions, availability, customerWorkspaceEnabled, hostedAlphaEnabled, hostedAlphaTaskTone, institutionalProductEnabled, type Availability, type HostedAlphaTaskResponse } from "@/lib/customer-workspace";
