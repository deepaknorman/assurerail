  ...
  return <><VenueHeader /><main className="wrap institutional-page customer-workspace">
    ...
    {enabled && institution && <>
      ...
      <section className="workspace-grid">
        ...
        {secondaryProductEnabled() && <article className="panel workspace-module"><div className="workspace-module-head"><div><span className="workspace-step">03B</span><h2>Secondary DA & PTC</h2></div><Link className="btn btn-primary" href="/workspace/secondary">Open register</Link></div><p>Observation-only title chain, transfer restrictions, consents, cash facts and authoritative-register reconciliation.</p></article>}
        {tokenisedProductEnabled() && <article className="panel workspace-module"><div className="workspace-module-head"><div><span className="workspace-step">03C</span><h2>Tokenised DA & PTC</h2></div><Link className="btn btn-primary" href="/workspace/tokenised">Open register</Link></div><p>Separate mirror journeys with explicit legal-finality, custody, connector, trustee and recordkeeper gates.</p></article>}
        {enterpriseIntegrationEnabled() && <article className="panel workspace-module"><div className="workspace-module-head"><div><span className="workspace-step">04</span><h2>Enterprise integrations</h2></div><Link className="btn btn-primary" href="/workspace/integrations">Open register</Link></div><p>Govern lender, trustee, recordkeeper, payment and operational connectors without confusing software conformance with external acceptance.</p></article>}
        ...
        <article className="panel workspace-module"><div className="workspace-module-head"><div><span className="workspace-step">05</span><h2>Commercial & service operations</h2></div><Link className="btn" href="/workspace/operations">Open operations</Link>{process.env.NEXT_PUBLIC_ASSURERAIL_ENGAGEMENT_BILLING_ENABLED === "true" && <Link className="btn" href="/workspace/assessment">Plan an assessment</Link>}</div><p>Accepted contracts, effective rate cards, issued shadow statements, implementation cohorts, service requests, reviews and evidence/data exit.</p><div className="boundary-note">Commercial records never grant route authority or change evidence, ownership, reconciliation or completion state.</div></article>
