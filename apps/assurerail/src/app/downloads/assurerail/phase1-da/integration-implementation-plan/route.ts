...
const artifact = findPackagedDownloadArtifact("DA-INTEGRATION-PLAN");
...
export async function GET(request: NextRequest) {
  ...
  return new Response(artifact.html, {
    ...
    headers: {
      ...protectedHeaders,
      "Content-Disposition": "inline; filename=AssureRail_Counterparty_Integration_Implementation_Plan.html",
